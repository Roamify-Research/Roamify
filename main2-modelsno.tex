...
\section{Methodology and Models}
    ...
    \subsection{Challenges and Adjustments}
        ...
        During the training and fine-tuning process, we encountered several challenges with the BERT, DistilBERT, and RoBERTa models. These models were unable to derive context from the dataset in depth. Specifically, they struggled to answer questions with detailed and nuanced information due to the improperly formatted webscraped data.

        As a result, we observed the following training loss and evaluation loss for BERT:
        \begin{itemize}
        ...
        \end{itemize}
        % Note: Add the correct scores for DistilBERT and RoBERTa later.

        Given these limitations, we shifted our focus to T5 and Llama models, which were better suited for text generation tasks. These models were able to quickly catch patterns and provide more accurate and detailed answers. Notably, T5 was faster than Llama in generating responses.
...
\section{Results and Evaluation}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{Train Loss:} [2.361349582672119, 1.0397248268127441, 1.1817796230316162]
            \item \textbf{Eval Loss:} [-1.7760356664657593, -3.611274003982544, -3.9986178874969482]
        \end{itemize}
