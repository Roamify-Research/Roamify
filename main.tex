...
\begin{abstract}
    ...
    Travel planning can often be a daunting and time-consuming task. Roamify, an AI-driven itinerary extension, aims to simplify this by providing curated suggestions based on user preferences. Leveraging advanced NLP models, Roamify generates personalized travel plans, enhancing the travel experience by transforming it from mere logistics to memorable adventures. This paper details Roamify's approach, methodologies, and its potential to fundamentally redefine travel planning.
