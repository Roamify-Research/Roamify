...
\author{Vikranth Udandarao\fnref{equal}}
\ead{vikranth22570@iiitd.ac.in}
\author{Noel Abraham Tiju\fnref{equal}}
\ead{noel22338@iiitd.ac.in}
\author{Muthuraj Vairamuthu\fnref{equal}}
\ead{muthuraj22307@iiitd.ac.in}
\author{Harsh Mistry\fnref{equal}}
\ead{harsh22200@iiitd.ac.in}
\author{Dr. Dhruv Kumar}
\ead{dhruv.kumar@iiitd.ac.in}

\affiliation{organization={Computer Science Engineering Dept, IIIT Delhi}, 
            city={New Delhi}, 
            country={India}}
...
\section{System Design and Architecture}
    ...
    \begin{tcolorbox}[rulewidth=1pt, innerleftmargin=15pt, innerrightmargin=15pt, top=0pt, bottom=0pt]
    ...
    \begin{tcolorbox}[rulewidth=1pt, innerleftmargin=15pt, innerrightmargin=15pt, innertopmargin=0pt, innerbottommargin=0pt]
    ...
    \subsection{Itinerary Generation}
        ...
        \begin{tcolorbox}[rulewidth=1pt, innerleftmargin=15pt, innerrightmargin=15pt, innertopmargin=15pt, innerbottommargin=15pt]
